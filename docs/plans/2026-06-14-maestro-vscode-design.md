...
- **Next:** Milestone 2 — **Copilot CLI adapter** (`2026-06-14-maestro-copilot-adapter.md`): spawn `copilot -p` per worktree, stream output, exit → done, validated through the real `Orchestrator`. The superseded Claude-adapter plan (`2026-06-14-maestro-claude-adapter.md`) is retained for its Agent-SDK research and the auth finding.
